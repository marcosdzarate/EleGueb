<?php
    ...
    if ( !empty($_POST)) {
        ...
        $sql = "DELETE FROM anestesia WHERE claveU=? AND fecha=? AND hora=? ";
        $q = $pdo->prepare($sql);
...
<button type="button" class="botonayuda" title="ayuda" onclick=ayudote(location.pathname)>
    ...
    <div class="panel panel-naranjino">
            <div class="panel-heading">
                <BR>
                  <h3 class="panel-title">Eliminar registro de anestesia para:</h3> <BR>
                    ...
                    <BR><BR>
                     ...
                     <?php if ($borrado=='no'): ?>
                        ...
                        <div class="form-actions">
                            ...
                            <a class="btn btn-default btn-sm" href="anestesia_index.php<?php echo $param0;?>">No</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php if (!empty($eError)): ?>
