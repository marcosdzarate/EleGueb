<?php
    ...
    if ( !empty($_POST)) {
        ...
        $sql = "DELETE FROM playa WHERE IDplaya=? ";
        $q = $pdo->prepare($sql);
    ...
    <div class="panel panel-grisDark">
            <div class="panel-heading">
                <BR>
                  ...
                  <h3 class="panel-title">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ID de playa (c&oacute;digo): <?php echo $pk_IDplaya;?></h3>
                <BR>
            ...
            <div class="panel-body ">
                ...
                <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                    <input type="hidden" name="pk_IDplaya" value="<?php echo $pk_IDplaya;?>"/>
                    ...
                    <BR><BR>
                     ...
                     <?php if ($borrado=='no'): ?>
                        ...
                        <div class="form-actions">
                            ...
                            <a class="btn btn-default btn-sm" onclick=parent.cierroM("playa_index.php")>No</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php if (!empty($eError)): ?>
