...
<BR><BR><BR><BR>
	...
	<div class="container" style="width:90%">
        <div class="panel panel-primary" style="background-color:transparent">
			...
			<div class="well">
			<h5 class="bg-info">filtrar por</h5>
...
<?php
	...
	else
	{
		...
		if ($valid){
			...
			echo '<br><h5 class="text-primary">Indiv&iacute;duos con m&aacute;s de un viaje</h5>'."\n\n";		
			$t=0;
			...
			echo '<br><h5 class="text-primary">Viajes con m&aacute;s de un dispositivo de reatreo</h5>'."\n\n";		
			echo "<p>";
			...
			echo '<br><h5 class="text-primary">Viajes con etapas intermedias</h5>'."\n\n";		
			echo "<p>";
			$va=-999;
			for ($t=0;$t<$nET;$t++)
			{
			...
			for ($v=0;$v<$nVT; $v++) {
				if ($viaVT[$v]["viajeID"]<>$viajeA){	/* cambia viaje */
					...
					/*botones de localizaciones y buceo*/
					echo '   <div class="col-sm-2">'."\n\n";
					if ($viaVT[$v]["conLoc"]=="tiene"){
						echo " <a  class='btn btn-warning btn-sm'>loc</a>";
					}
					echo '   </div>'."\n\n";
					echo '   <div class="col-sm-2">'."\n\n";
					if ($viaVT[$v]["conBuc"]<>""){
						echo " <a  class='btn btn-warning btn-sm'>buc</a>";
					}
					echo '   </div>'."\n\n";
				...
				if ($ee>=0) {
					...
					while ($viaVT[$v]["viajeID"]==$bucST[$ee]["viajeID"]){
						echo '    <tr>'."\n\n";
						echo '	   <td>'.$bucST[$ee]["tablaDetalle"].'</td>'."\n\n";
						echo '	   <td>'."ON".'</td>'."\n\n";
