    ...
    <div class="panel panel-grisDark">
            <div class="panel-heading">
                <BR>
                  ...
                  <h3 class="panel-title">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ID del colaborador (c&oacute;digo): <?php echo $pk_IDcolaborador;?></h3>
                <BR>
                    ...
                    <BR><BR>
                     ...
                     <?php if ($borrado=='no'): ?>
                        ...
                        <div class="form-actions">
                            ...
                            <a class="btn btn-default btn-sm" onclick=parent.cierroM("colaborador_index.php")>No</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php if (!empty($eError)): ?>
