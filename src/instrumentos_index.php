...
$(document).ready(function() {
       ini_datatable ('#tablax' , 'instrumentos_tb.php?condi=<?php echo $condi;?>',15,0) ;
} );
...
<button type="button" class="botonayuda" style="top:180px" title="ayuda" onclick=ayudote(location.pathname)>
    ...
    <div class="container well"  style="width:820px">
            <div class="row">
                <h4>instrumentos</h4>
            </div>
            ...
            <div class="panel panel-grisDark">
                <div class="panel-heading">
                    <h3 class="panel-title">lista de instrumentos</h3>
                </div>
                ...
                <div class="row">
					<div class="col-sm-3">
					   <?php
						 if (edita()) {
							 ECHO '<a onclick=ventanaM("instrumentos_crear.php'. $param .'",this.title) title="agregar instrumentos" class="btn btn-primary btn-sm">nuevo</a>&nbsp;&nbsp;';
							 }
						?>
					</div>
