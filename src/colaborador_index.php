...
require_once 'tb_validar.php';
	...
	if (isset($_POST['descarga']))
	{
		...
		$sql= "SELECT * FROM $laTabla ORDER BY 1;";
...
$(document).ready(function() {
       ini_datatable ('#tablax' , 'colaborador_tb.php',15,0) ;
} );
...
<button type="button" class="botonayuda" style="top:180px" title="ayuda" onclick=ayudote(location.pathname)>
    ...
    <div class="container well" style="width:750px">
            <div class="row">
                <h4>participantes en las actividades de campo</h4>
            </div>
            ...
            <div class="panel panel-grisDark">
                ...
                <div class="row">
                   ...
                   <?php
						 if (edita()) {
							 ECHO '<a title="agregar nuevo participante" onclick=ventanaM("colaborador_crear.php",this.title) class="btn btn-primary btn-sm" >nuevo</a>&nbsp;&nbsp;';
							 }
						?>
