...
while ( $aRow = mysqli_fetch_array( $rResult ) )
{
    ...
    if (edita()) {
      $row[] = '<a class="btn btn-default" title="vista de los datos de publicaciones" onclick=ventanaM("publicaciones_ver.php?ID='.urlencode($aRow['ID']).'",this.title)>'.
               '<span class="glyphicon glyphicon-eye-open"></span></a> '.
               '<a class="btn btn-success" title="editar datos de publicaciones" onclick=ventanaM("publicaciones_editar.php?ID='.urlencode($aRow['ID']).'",this.title)>'.
               '<span class="glyphicon glyphicon-edit"></span></a> '.
               '<a class="btn btn-danger" title="eliminar publicaciones" onclick=ventanaM("publicaciones_borrar.php?ID='.urlencode($aRow['ID']).'",this.title)>'.
               '<span class="glyphicon glyphicon-erase"></span></a> '.
               '<a class="btn btn-warning" title="descargar publicaci&oacute;n" download  href="'.dirPublicaciones.$aRow['archivo'].'">'.
