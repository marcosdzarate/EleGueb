...
?>
    ...
    <div class="container well"  style="font-size:14px;width:80%" >
			<h3>viajes con localizaciones para descargar</h3>
		...
		<br>
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">descarga individual</h3>
                </div>
...
<?php
					...
					for ($v=$ndv-1; $v>=0; $v--)
					{
						if($datosViajes[$v]['conLoc']=='tiene') {
							...
							echo '<td><a class="btn btn-warning" title="descargar localizaciones" onclick=descargaTrack('.urlencode($datosViajes[$v]['viajeID']).','.$datosViajes[$v]['ptt'].')>'.
...
<!-- para ventanas MODAL de aqui para abajo
 ...
 <div w3-include-html="tb_ventanaMiniDescarga.html"></div>
<script>
w3.includeHTML();
</script>
