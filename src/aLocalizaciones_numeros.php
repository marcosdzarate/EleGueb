...
$salidax = "pantalla";
$preguntaCal = "NumerosLocalizaciones";
$tipoTempo="";

$queTabla = 'buceos';  //para validar tipo- no es buceo pero sirve!!
...
if (!empty($_POST)) {
	...
	if ($salidax<>"pantalla") {
		switch ($preguntaCal)  {	
			...
			case "NumerosLocalizaciones":
				$sql ="CALL `locx-viajes numeros`('".$tipoTempo."');"; 
				if ($salidax<>'pantalla') {
					if ($salidax == 'csv') {
...
<div class="container-fluid" style="width:90%; padding-top:10px;">   
		...
		<div class="col-sm-8">
			<form id="fRespuestas" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
					<div class="well" style="font-size:14px"  > 
					    <h3> estad&iacute;sticas b&aacute;sicas de las localizaciones</h3>
						<br>
						<div class="row">
							<div class="col-sm-5" >
	...
	<br><br>
			...
			<div class="row">
				...
				<div class="col-sm-4" >
					<div class="panel panel-consulta" onclick='datosMres("NumerosLocalizaciones","")' >
						<div class="panel-heading "><span class="badge badge">1</span></div>
						<div class="panel-body" id=PNumerosLocalizaciones>		  
							n&uacute;meros por viaje e instrumento
							<br><br>
							<small>localizaciones filtradas, LQ, distancias....</small>
							<br><br>
						</div>
					</div>
...
if (!empty($_POST)) {
	if ($salidax=="pantalla") {
		...
		switch ($preguntaCal)  {	
			...
			case "NumerosLocalizaciones":
				echo '              <div class="panel-heading" >Estad&iacute;sticas b&aacute;sicas de las localizaciones'.$tt.'</div>
