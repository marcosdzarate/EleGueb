<?php
     ...
     */
    $aColumns = array('claveU','temporada','tipoTempo','cateDesc','sexo','tags','marcas' );
...
while ( $aRow = mysqli_fetch_array( $rResult ) )
{
    ...
    for ( $i=0 ; $i<count($aColumns) ; $i++ )
    {
	  ...
	  $t01 .="'";
	  $cu ="'".$aRow['claveU']."'";
      $row[] = '<button class="btn btn-default" type=button title="&eacute;sta es la pareja" onclick="EsLaPareja('.$cu.','.$t01.');">'.
