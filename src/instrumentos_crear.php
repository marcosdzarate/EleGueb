<?php
    ...
    if ( !empty($_POST)) {
        ...
        // autoincrement!!! $instrumentoNRO = limpia($_POST['instrumentoNRO']);
        ...
        // autoincrement!!! $instrumentoNROError = validar_instrumentoNRO ($instrumentoNRO,$valid,true);
    ...
    // validacion entre campos
        ...
        if ($valid and isset($_POST['guardar'])) {
            ...
            $sql = "INSERT INTO instrumentos (tipo,identificacion,serial_num,modelo,fabricante,nuestro,disponible,comentario) values(?,?,?,?,?,?,?,?)";
            $q = $pdo->prepare($sql);
            $q->execute(array($tipo,$SQLidentificacion,$SQLserial_num,$SQLmodelo,$SQLfabricante,$nuestro,$disponible,$SQLcomentario));
	...
	<span class="glyphicon glyphicon-question-sign"></span>
        ...
        <div class="panel panel-naranjino">
            <div class="panel-heading">
                <h3 class="panel-title">nuevo registro de instrumento</h3>
            </div>
