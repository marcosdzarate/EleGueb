<?php
     ...
     */
    $aColumns = array('claveU','fecha','hora','conCual','duracion' );
...
while ( $aRow = mysqli_fetch_array( $rResult ) )
{
    ...
    if (edita()) {
      $row[] = '<a class="btn btn-success" title="editar" href="copula_editar.php?claveU='.urlencode($aRow['claveU']).'&fecha='.urlencode($aRow['fecha']).'&hora='.urlencode($aRow['hora']).'&xtrx='.$xtrx.'">'.
               '<span class="glyphicon glyphicon-edit"></span></a> '.
               '<a class="btn btn-danger" title="eliminar" href="copula_borrar.php?claveU='.urlencode($aRow['claveU']).'&fecha='.urlencode($aRow['fecha']).'&hora='.urlencode($aRow['hora']).'&xtrx='.$xtrx.'">'.
               '<span class="glyphicon glyphicon-erase"></span></a> '.
                 '';
    }
    else  {
      $row[] = '<a class="btn btn-default" title="ver" href="copula_editar.php?claveU='.urlencode($aRow['claveU']).'&fecha='.urlencode($aRow['fecha']).'&hora='.urlencode($aRow['hora']).'&xtrx='.$xtrx.'">'.
