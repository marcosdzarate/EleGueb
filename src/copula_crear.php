<?php
    ...
    // validacion entre campos
        ...
        if ($valid and isset($_POST['guardar'])) {
            ...
            $sql = "INSERT INTO copula (claveU,fecha,hora,conCual,conCualCu,duracion,comentario) values(?,?,?,?,?,?,?)";
            $q = $pdo->prepare($sql);
            $q->execute(array($claveU,$fecha,$hora,$SQLconCual,$SQLconCualCu,$SQLduracion,$SQLcomentario));
	...
	<span class="glyphicon glyphicon-question-sign"></span>
        ...
        <div class="panel panel-naranjino">
            <div class="panel-heading">
                <h3 class="panel-title">nuevo registro de c&oacute;pula</h3>
            </div>
                    ...
                    <div class=col-sm-8>
                        <div class="container" style="width:100%">                   
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">parejas posibles en la temporada</h3>
                                </div>
                                <div class="panel-body">
